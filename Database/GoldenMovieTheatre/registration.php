...
<div class="content">
	<div class="wrap">
      ...
      <div class="form-group has-feedback">
        ...
        <?php $frm->validate("phone",array("required","label"=>"Mobile Number")); // Validating form using form builder written in form.php ?>
      ...
      <div class="form-group has-feedback">
        ...
        <?php $frm->validate("cpassword",array("required","label"=>"Confirm Password","identical"=>"password Password")); // Validating form using form builder written in form.php ?>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
